...
SWEP.PrintName					= "[ALLIES]105mm WP strike"
SWEP.strikedalay				= 10
SWEP.strikeentity     	  		= "gb_shell_105mmWP"
SWEP.Primary.Ammo				= "Allied radio battery"
SWEP.Team						= "Allies"
SWEP.StrikeString				= "Artillery"
SWEP.Bomber						= false

SWEP.RandomPos					= 1200
SWEP.LoopTimerTime1				= 2
SWEP.LoopTimerTime2				= 2.5
SWEP.FireRate					= 1
SWEP.ShellCount					= 24

SWEP.SoundName					= "/radio/allied/british/incendiaryartillerybegin"
...
SWEP.RadioCallInSnd				= "requestincendiaryartillery"